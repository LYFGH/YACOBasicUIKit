...
@implementation UIDevice (YACODevice)
...
- (YACONetworkType)yaco_networkType
{
    ...
    switch (status) {
        case AFNetworkReachabilityStatusUnknown: {
            return YACONetworkTypeOther;
            break;
        }
        case AFNetworkReachabilityStatusNotReachable: {
            return YACONetworkTypeUnReachable;
            break;
        }
