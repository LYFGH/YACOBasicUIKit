...
@interface YACOAutoScrollLabel() <UIScrollViewDelegate>
...
@implementation YACOAutoScrollLabel
...
- (void)initialize
{
    ...
    // 初始化设置
    _direction = YACOAutoScrollDirectionType_Left;
...
- (void)setText:(NSString *)theText {
    [self yaco_setText:theText refreshLabels:YES];
}

- (void)yaco_setText:(NSString *)theText refreshLabels:(BOOL)refresh {
    // 忽略相同文本的变化
...
- (void)setAttributedText:(NSAttributedString *)theText {
    [self yaco_setAttributedText:theText refreshLabels:YES];
}

- (void)yaco_setAttributedText:(NSAttributedString *)theText refreshLabels:(BOOL)refresh {
...
- (void)setDirection:(YACOAutoScrollDirectionType)direction
{
...
- (void)scrollLabelIfNeeded
{
    ...
    if (self.direction != YACOAutoScrollDirectionType_Right && self.direction != YACOAutoScrollDirectionType_Left) {
    ...
    switch (self.direction) {
        case YACOAutoScrollDirectionType_Left:
            self.scrollView.contentOffset = CGPointZero;
            break;
        case YACOAutoScrollDirectionType_Right:
            self.scrollView.contentOffset = CGPointMake(width + self.labelSpacing, 0);
            break;
        case YACOAutoScrollDirectionType_Top:
            self.scrollView.contentOffset = CGPointZero;
            break;
        case YACOAutoScrollDirectionType_Bottom:
